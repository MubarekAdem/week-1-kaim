...
def merge_sentiment_and_returns(news_df, stock_df, 
    ...
    daily_sentiment = calculate_daily_sentiment(news_df, news_date_col, sentiment_col)
...
def calculate_correlation(merged_df, sentiment_col='Avg_Sentiment', return_col='Daily_Return'):
    ...
    # Pearson correlation
    pearson_r, pearson_p = pearsonr(clean_df[sentiment_col], clean_df[return_col])
    
    # Spearman correlation
    spearman_r, spearman_p = spearmanr(clean_df[sentiment_col], clean_df[return_col])
